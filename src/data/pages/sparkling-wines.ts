    ...
    wines: [
      {
        ...
        image: "../img/wines/Sparkling wine yellow.jpg",
        body: [
      ...
      },
      {
        ...
        link: {
          label: "Data Sheet",
          to: "dulzon-azul-datasheet",
        },
      },
      {
        heading: "Dulzón Rosado",
        subheading: "The elegancy of the Spanish bubbles",
        image: "../img/wines/Sparkling wine pink.jpg",
        body: [
