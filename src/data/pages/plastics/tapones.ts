...
export const frontmatter: CategoryPage = {
  ...
  sections: {
    intro: {
      heading: "Tapones",
      image: "../../img/plastics/4WelcomeImage_Caps.jpg",
      body: [
    ...
    categoryList: {
      categoryItems: [
        {
          heading: "Tapones",
          image: "../../img/plastics/Product_Cap4.jpg",
          body: [
            "¿Interesado en Tapones?",
          ...
          spec: [
            {
              ...
              params: [
                {
                  key: "Formatos",
                  value: "18/410; 18/415; 20/410; 20/415; 24/410; 24/415; 28/400; 28/410; 28/415",
                },
                {
                  key: "Modelos",
                  value: "Rosca, Flip Top, Disc Top, Push pull con válvula de silicona o sin válvula, modelo twist.",
                },
                {
                  key: "Diseño",
