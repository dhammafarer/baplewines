...
export const frontmatter: CategoryPage = {
  ...
  sections: {
    intro: {
      ...
      image: "../../img/plastics/3WelcomeImage_Minisprayer.jpg",
      body: [
    ...
    categoryList: {
      categoryItems: [
        {
          heading: "Micropulverizadores",
          image: "../../img/plastics/Product_Micropulver.jpg",
          body: [
          "¿Interesado en Micropulverizadores?",
          ...
          spec: [
            {
              ...
              params: [
                {
                  key: "Formatos",
                  value: "15/400; 15/410; 18/400; 18/410; 18/415; 20/400; 20/410; 22/415; 24/410; 28/400; 28/410; 28/415",
                },
                {
                  key: "Ratio Descarga",
                  value: "0.10 - 0.14 ml/T; 0.14 - 0.20 ml/T; 0.20 ± 0.05 ml/T; 0.75 ± 0.05 ml/T",
                },
                {
                  key: "Diseño",
