    ...
    wines: [
      {
        ...
        link: {
          label: "Data Sheet",
          to: "Azua-coleccion-bobal-datasheet",
        },
      },
      {
        heading: "Azua Crianza",
        subheading: "La Barrica de Vitivinos",
        image: "../img/wines/crianza.jpg",
        body: [
        ...
        link: {
          label: "Data Sheet",
          to: "Azua-Crianza-datasheet",
        },
      },
      {
        heading: "Azua Roble",
        subheading: "La Barrica de Vitivinos",
        image: "../img/wines/roble.jpg",
        body: [
      ...
      },
      {
        ...
        link: {
          label: "Data Sheet",
          to: "Llanos-del-Marques-datasheet",
        },
      },
      {
        heading: "Azua Rosado",
        subheading: "La juventud de Vitivinos",
        image: "../img/wines/Rosado.jpg",
        body: [
